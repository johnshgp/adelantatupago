...
class ResCompanyInherit(models.Model):
	...
	OPERATION_TYPE = [('09','AIU'),('10','Estandar *'),
    ('11','Mandatos')]
	...
	operation_type = fields.Selection(OPERATION_TYPE, string='Tipo de operación DIAN', required=True)
	...
	def query_numbering_range(self):
		...
		ProviderID = self.partner_id.vat
